...
(function () {
  ...
  const MESSAGES = {
    ...
    'setup.descAdvanced': {
      zh: '配置思考间隔、启动模式、邮件服务、OCR、视觉分析、图像生成、科学计算等',
      en: 'Configure thinking interval, startup mode, email, OCR, vision, image generation, and science',
      es: 'Configura intervalo de pensamiento, modo de inicio, email, OCR, visión, generación de imágenes, etc.',
      hu: 'Konfigurálja a gondolkodási időt, indítómódot, e-mailt, OCR-t, látást, képgenerálást, stb.',
      ru: 'Настройте интервал размышлений, режим запуска, почту, OCR, зрительный анализ, генерацию изображений и др.',
    },
    'setup.thinkingLabel': {
      zh: '思考间隔（毫秒）',
