...
const ToastManager = {
  ...
  _getIcon(type) {
    switch (type) {
      ...
      case 'warning':
        // 三角形警告图标（区别于 error 的圆形感叹号图标）
        return '<svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z"/></svg>';
      case 'error':
