 ...
 */
export async function spawnAgent(persona: string, name: string, instruction: string): Promise<any> {
 ...
 */
export async function delegateTask(agentId: string, task: string): Promise<any> {
 ...
 * 获取集群状态
 */
export async function getClusterStatus(): Promise<any> {
 ...
 * 停止所有智能体
 */
export async function stopAllAgents(): Promise<any> {
 ...
 */
export async function parallelExecute(tasks: any): Promise<any> {
 ...
 */
export async function panelDiscussion(topic: string, agentIds: any, moderatorInstruction: string = ''): Promise<any> {
  let ids;
  try {
 ...
 */
export async function pipeline(steps: any): Promise<any> {
  let stepsArr;
  try {
 ...
 */
export async function voting(question: string, agentIds: any, options: any = '[]'): Promise<any> {
  let ids;
  let opts: any[] = [];
  try {
    ids = typeof agentIds === 'string' ? JSON.parse(agentIds) : agentIds;
