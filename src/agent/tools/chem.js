 ...
 */
async function elementInfo(symbol) {
  try {
 ...
 * @returns {Promise<Object>}
 */
async function molWeight(formula) {
  try {
 ...
 * @returns {Promise<Object>}
 */
async function elementComposition(formula) {
  try {
    const elements = parseFormula(formula);
    let total = 0;
    const weights = {};
 ...
 * @returns {Promise<Object>}
 */
async function molarity(moles, volume) {
  try {
 ...
 * @returns {Promise<Object>}
 */
async function dilution(c1, v1, c2, v2) {
  try {
 ...
 * @returns {Promise<Object>}
 */
async function idealGasLaw(P, V, n, T) {
  try {
 ...
 * @returns {Promise<Object>}
 */
async function gasDensity(mw, T, P) {
  try {
