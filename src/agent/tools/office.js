...
async function createPpt(options, ...rest) {
  try {
    let outputPath, slides = [], title = 'Untitled', author = 'CogitoAgent';
...
async function createWord(options, ...rest) {
  try {
    let outputPath, paragraphs = [], title = 'Untitled', author = 'CogitoAgent';
...
async function createExcel(options, ...rest) {
  try {
    let outputPath, sheets = [];
