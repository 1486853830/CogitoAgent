 ...
 * 发送邮件
 */
async function sendEmail(to: string, subject: string, body: string, options: any = {}): Promise<any> {
 ...
 * 发送带附件的邮件
 */
async function sendEmailWithAttachments(to: string, subject: string, body: string, attachments: any): Promise<any> {
 ...
 * 发送邮件模板
 */
async function sendTemplateEmail(to: string, subject: string, templateName: string, data: any): Promise<any> {
  const templates: any = {
    'welcome': {
